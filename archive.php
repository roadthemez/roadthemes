					...
					<?php if ( have_posts() ) : ?>
						<header class="archive-header">
							<h1 class="archive-title"><?php
								if ( is_day() ) :
									printf( esc_html__( 'Daily Archives: %s', 'sozo' ), '<span>' . get_the_date() . '</span>' );
								elseif ( is_month() ) :
									printf( esc_html__( 'Monthly Archives: %s', 'sozo' ), '<span>' . get_the_date( _x( 'F Y', 'monthly archives date format', 'sozo' ) ) . '</span>' );
								elseif ( is_year() ) :
									printf( esc_html__( 'Yearly Archives: %s', 'sozo' ), '<span>' . get_the_date( _x( 'Y', 'yearly archives date format', 'sozo' ) ) . '</span>' );
								else :
									esc_html_e( 'Archives', 'sozo' );
								endif;
							?></h1>
